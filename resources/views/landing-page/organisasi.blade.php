    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>ORGANISASI<br>DINAS PENDIDIKAN<br>KABUPATEN PURWAKARTA</h1>
        ...
        <div class="container-fluid services py-5 mb-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                    <h1 class="text-black "> STRUKTUR ORGANISASI <br> DINAS PENDIDIKAN PURWAKARTA</h1>
                    <h1></h1>
                </div>
                <div class="row justify-content-center">
                        ...
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <div class="icon-box">
                                        <img src="{{ asset('storage/landing-page') }}/assets/img/organisasi.png" alt="Icon" class="large-image">
                                    </div>
                                </div>
                            </div>
                        </div>
