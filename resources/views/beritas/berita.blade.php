...
<div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-gray-800">Berita</h2>
      <p class="mt-1 text-gray-600 dark:text-gray-800">Stay in the know with insights from industry experts.</p>
    </div>
    <!-- End Title -->
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a class="group" href="#">
        ...
        <div class="mt-7">
          <h3 class="text-xl font-semibold text-gray-800 group-hover:text-gray-900 dark:text-gray-800 dark:group-hover:text-gray-900">
            Onsite
          </h3>
          <p class="mt-3 text-gray-800 dark:text-gray-900">
